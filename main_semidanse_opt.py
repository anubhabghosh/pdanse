...
from src.semidanse import SemiDANSE, train_danse_semisupervised  # noqa: E402
from bin.measurement_fns import get_measurement_fn # noqa: E402
...
def main():
    ...
    if measurement_fn_type is None:
        ...
        estimator_options["H"] = torch.autograd.functional.jacobian(
            func=get_measurement_fn(fn_name=measurement_fn_type),
            inputs=torch.randn(n_states,)
        )
